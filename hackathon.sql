...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 25 Avril 2017 à 15:04
...
(1102, 'Bondur', 'Gerard', 'x5408', 'gbondur@classicmodelcars.com', '4', '7ab4f-parisescalade-formulaire-inscription.pdf', 'Sale Manager (EMEA)'),
...
(1703, 'Alex', 'B', 'a', 'a@a.fr', 'a', 'a', 'a'),
(1704, '', '', '', '', '', 'bfe14-parisescalade-formulaire-inscription.pdf', '');
...
--
ALTER TABLE `employees`
  MODIFY `employeeNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1705;
